 ...
 */
final class Version20250429113019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reservation (
          ...
          ticket_code BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\',
        ...
        $this->addSql('ALTER TABLE
          reserved_seat
        ADD
          CONSTRAINT FK_6DF983B9B83297E7 FOREIGN KEY (reservation_id) REFERENCES reservation (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE
          reserved_seat
        ADD
