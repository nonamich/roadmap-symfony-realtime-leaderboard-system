 ...
 */
final class Version20250402013335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6DF983B9C1DAFE35 ON reserved_seat (seat_id)');
        $this->addSql('CREATE INDEX IDX_6DF983B9B83297E7 ON reserved_seat (reservation_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_SEAT_AND_RESERVATION ON reserved_seat (seat_id, reservation_id)');
        ...
        $this->addSql('ALTER TABLE
          reserved_seat
        ADD
          CONSTRAINT FK_6DF983B9C1DAFE35 FOREIGN KEY (seat_id) REFERENCES seat (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE
          reserved_seat
        ADD
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reserved_seat DROP CONSTRAINT FK_6DF983B9C1DAFE35');
